...
import com.foamtec.qas.security.AppRoleDataOnDemand;
import com.foamtec.qas.security.AppUser;
import com.foamtec.qas.security.AppUserDataOnDemand;
...
privileged aspect AppUserDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    AppRoleDataOnDemand AppUserDataOnDemand.appRoleDataOnDemand;
    ...
    public void AppUserDataOnDemand.setNeedLogin(AppUser obj, int index) {
        Boolean needLogin = Boolean.TRUE;
        obj.setNeedLogin(needLogin);
    }
