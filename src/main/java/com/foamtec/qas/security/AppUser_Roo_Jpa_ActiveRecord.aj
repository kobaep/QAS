...
privileged aspect AppUser_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> AppUser.fieldNames4OrderClauseFilter = java.util.Arrays.asList("username", "password", "name", "enabled", "needLogin", "userEmail", "departmentCode", "userRole");
